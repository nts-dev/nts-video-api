...
class UploadResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'thumbnailLink' =>$URL . $ROOT . $this->disk . "/thumbnails/pic" . rand(0, 3) . ".png",
            'sprintLink' => $URL . $ROOT .  "/sprint/index.jpg",
            'videoLink_raw' => $URL . $ROOT . $this->raw_link,
            'disk' => $this->disk,
            'webm' =>$URL . $ROOT . $this->disk . "/web.webm",
            'asInDisk' =>  $this->raw_link,
            'videoLink' =>$URL . $ROOT . $this->disk . "/hsl/master.m3u8",
...
//            'user_picture' => isset($this->user->profile) ? $this->us er->profile->profile_pic_url : null,
